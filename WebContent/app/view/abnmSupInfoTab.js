/*
 * File: app/view/abnmSupInfoTab.js
 *
...
Ext.define('MyApp.view.abnmSupInfoTab', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.abnmSupInfoTab',
                    ...
                    items: [
                        {
                            ...
                            items: [
                                {
                                    xtype: 'gridpanel',
                                    id: 'abnmSupInfoPubGrid',
                                    collapsible: false,
                                    title: '',
                                    forceFit: true,
                                    store: 'ArticlePubWFJCStore',
                                    columns: [
                                        {
                                            xtype: 'rownumberer',
                                            width: 47,
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateAbnmSup').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordAbnmSup').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticlePubWFJCStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        //mystore.load(
                                                        //{params:{
                                                        //    start:"0",
                                                                        ...
                                                                        if (myform.isValid()) { // make sure the form contains valid data before submitting
                                                                            myform.submit({
                                                                                ...
                                                                                success: function(form, action) {
                                                                                    ...
                                                                                    //}
                                                                                    // );
                                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftWFJCStore'); //获得store对象
                                                                                    mystore.load();
                                                                                    win.close();
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleRecWFJCStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubWFJCStore');
                                                                    mystore2.load();
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'gridpanel',
                                    id: 'abnmSupInfoDraftGrid',
                                    collapsible: false,
                                    title: '',
                                    forceFit: true,
                                    store: 'ArticleDraftWFJCStore',
                                    columns: [
                                        {
                                            xtype: 'rownumberer',
                                            width: 47,
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateDraft12').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordDraft12').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleDraftWFJCStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        //mystore.load(
                                                        //{params:{
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftWFJCStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubWFJCStore');
                                                                    mystore2.load();
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'gridpanel',
                                    id: 'abnmSupInfoRecGrid',
                                    collapsible: false,
                                    title: '',
                                    forceFit: true,
                                    store: 'ArticleRecWFJCStore',
                                    columns: [
                                        {
                                            xtype: 'rownumberer',
                                            width: 47,
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateRec12').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordRec12').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleRecWFJCStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        //mystore.load(
                                                        //{params:{
                                                        //    start:"0",
        ...
        var win = new Ext.Window({
            ...
            items: [{
                ...
                },
                {
                    ...
                    text: '保存',
                    handler: function() {
                        var myform = Ext.getCmp('articleDraftUpdateForm').getForm();
                        if (myform.isValid()) { // make sure the form contains valid data before submitting
                            myform.submit({
            ...
            var win = new Ext.Window({
                ...
                items: [{
                    ...
                    },
                    {
                        ...
                        text: '保存',
                        handler: function() {
                            var myform = Ext.getCmp('articleRecUpdateForm').getForm();
                            if (myform.isValid()) { // make sure the form contains valid data before submitting
                                myform.submit({
