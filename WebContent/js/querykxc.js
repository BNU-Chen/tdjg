...
function querykxc(querywhere){
        ...
        //build query task
        queryTask = new esri.tasks.QueryTask("http://localhost:6080/arcgis/rest/services/xianzhuang/MapServer/0");
...
function showFindResults(results)
{
   ...
   //在右上方显示查询模糊查询结果数目
   var resultdivhtml = "根据关键字'<b>"+searchkeyword+"</b>',查询到空心村"+results.length+"个地块";
   //alert(resultdivhtml);
   dojo.byId("resultdiv").innerHTML=resultdivhtml;
